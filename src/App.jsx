...
import  InternalGenerator  from '@/pages/InternalGenerator.jsx'
...
import { Calculator, Globe, Server, Palette, Search, Wrench, TrendingUp } from 'lucide-react'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/internal-generator" element={<InternalGenerator />} />
      </Routes>
    </BrowserRouter>
  );
}
